...
contract insightTokenTest is Test {
    ...
    //     // Expect the TokensUnstaked event
    //     vm.expectEmit(true, false, false, true);
    ...
    //     uint256 expectedTokens = points * 10**16;
        
    //     // Verify reward points were reset
    //     assertEq(insightToken.userRewardPoints(user1), 0);
        
    //     // Verify tokens were transferred
    //     assertEq(insightToken.balanceOf(rewardsPool), rewardsPoolBalanceBefore - expectedTokens);
    //     assertEq(insightToken.balanceOf(user1), user1BalanceBefore + expectedTokens);
    // }
